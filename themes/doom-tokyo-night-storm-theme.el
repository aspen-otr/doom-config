...
;; Copied from the official Doom Emacs Tokyonight theme, edited.
...
(def-doom-theme doom-tokyo-night-storm
  "A clean, dark theme that celebrates the lights of downtown Tokyo at night. Storm version"

  ;; name        default   256       16
  ((bg         '("#1f2335" nil       nil            ))
   (bg-alt     '("#24283b" nil       nil            ))
   (base0      '("#414868" "#414868" "black"        )) ; TODO
   (base1      '("#51587a" "#51587a" "brightblack"  )) ; TODO
   (base2      '("#61698b" "#61698b" "brightblack"  )) ; TODO
   (base3      '("#71799d" "#71799d" "brightblack"  )) ; TODO
   (base4      '("#8189af" "#8189af" "brightblack"  )) ; TODO
   (base5      '("#9099c0" "#9099c0" "brightblack"  )) ; TODO
   (base6      '("#a0aad2" "#a0aad2" "brightblack"  )) ; TODO
   (base7      '("#b0bae3" "#b0bae3" "brightblack"  )) ; TODO
   (base8      '("#c0caf5" "#c0caf5" "white"        )) ; TODO
   ...
   (green      '("#73daca" "#73daca" "green"        )) ; nvim `green1'
   ...
   (cyan       '("#b4f9f8" "#b4f9f8" "brightcyan"   )) ; nvim `blue6'
   (dark-cyan  '("#7dcfff" "#7dcfff" "cyan"         )) ; nvim `cyan'
   ; Additional custom colors
   (dark-green '("#9ece6a" "#9ece6a" "green"        )) ; nvim `green'
